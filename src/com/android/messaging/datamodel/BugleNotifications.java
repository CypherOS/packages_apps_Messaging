...
public class BugleNotifications {
    ...
    private static void processAndSend(final NotificationState state, final boolean silent,
        ...
        String id = NotificationChannelController.DEFAULT_CHANNEL_ID;
        if (NotificationChannelController.getNotificationChannel(context, conversationId) != null) {
            id = conversationId;
        }
...
//            .setPublicVersion(null)    // TODO: when/if we ever support different
            ...
            if (attachmentBitmap != null) {
                ...
                final NotificationCompat.Builder photoPageNotifBuilder =
                        new NotificationCompat.Builder(
                                Factory.get().getApplicationContext(), NotificationChannelController.DEFAULT_CHANNEL_ID);
    ...
    private static synchronized void doNotify(final Notification notification,
        ...
        NotificationChannelController.createNotificationChannelGroup(context,
    ...
    private static void playObservableConversationNotificationSound(final String conversationId) {
        ...
        NotificationChannel channel = NotificationChannelController.getNotificationChannel(context, conversationId);
        if (channel == null) {
            channel = NotificationChannelController.getNotificationChannel(context, NotificationChannelController.DEFAULT_CHANNEL_ID);
        }
    ...
    public static void notifyEmergencySmsFailed(final String emergencyNumber,
        ...
        final NotificationCompat.Builder builder =
                new NotificationCompat.Builder(context, NotificationChannelController.DEFAULT_CHANNEL_ID);
